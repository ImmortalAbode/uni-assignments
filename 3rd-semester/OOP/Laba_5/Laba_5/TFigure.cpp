...
void TCircle::Free(TFigure**& ptr_circles_mass, int& count_size_mass_circles)
{
	delete_element_shape<TFigure>(ptr_circles_mass, count_size_mass_circles);
}
...
void TEllipse::Free(TFigure**& ptr_ellipses_mass, int& count_size_mass_ellipses)
{
	delete_element_shape<TFigure>(ptr_ellipses_mass, count_size_mass_ellipses);
}
...
void TQuadrilateral::Free(TFigure**& ptr_quadrilaterals_mass, int& count_size_mass_quadrilaterals)
{
	delete_element_shape<TFigure>(ptr_quadrilaterals_mass, count_size_mass_quadrilaterals);
}
...
void TTrapeze::Free(TFigure**& ptr_trapezes_mass, int& count_size_mass_trapezes)
{
	delete_element_shape<TFigure>(ptr_trapezes_mass, count_size_mass_trapezes);
}
...
void TRectangle::Free(TFigure**& ptr_rectangles_mass, int& count_size_mass_rectangles)
{
	delete_element_shape<TFigure>(ptr_rectangles_mass, count_size_mass_rectangles);
}
...
void TRhombus::Free(TFigure**& ptr_rhombuses_mass, int& count_size_mass_rhombuses)
{
	delete_element_shape<TFigure>(ptr_rhombuses_mass, count_size_mass_rhombuses);
}
