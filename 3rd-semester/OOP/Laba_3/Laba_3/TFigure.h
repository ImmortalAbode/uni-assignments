...
protected:
	...
	virtual void MoveTo(float change_coordinate_x, float change_coordinate_y) = 0;
...
public:
	...
	void MoveTo(float change_coordinate_x, float change_coordinate_y) override;
	void Free(TCircle**& ptr_circles_mass, int& count_size_mass_circles);
...
public:
	...
	void Show(sf::RenderWindow& window) override;
	void MoveTo(float change_coordinate_x, float change_coordinate_y) override;
	void Free(TEllipse**& ptr_ellipses_mass, int& count_size_mass_ellipses);
...
public:
	...
	void Show(sf::RenderWindow& window) override;
	void MoveTo(float change_coordinate_x, float change_coordinate_y) override;
	void Free(TQuadrilateral**& ptr_quadrilaterals_mass, int& count_size_mass_quadrilaterals);
...
public:
	...
	void Show(sf::RenderWindow& window) override;
	void MoveTo(float change_coordinate_x, float change_coordinate_y) override;
	void Free(TTrapeze**& ptr_trapezes_mass, int& count_size_mass_trapezes);
...
public:
	...
	void Show(sf::RenderWindow& window) override;
	void MoveTo(float change_coordinate_x, float change_coordinate_y) override;
	void Free(TRectangle**& ptr_rectangles_mass, int& count_size_mass_rectangles);
	float getLength();
	float getWidth();
...
public:
	...
	void Show(sf::RenderWindow& window) override;
	void MoveTo(float change_coordinate_x, float change_coordinate_y) override;
	void Free(TRhombus**& ptr_rhombuses_mass, int& count_size_mass_rhombuses);
	float getLength();
	int getDegree();
	void changeLength(int dlength);
...
public:
	TLinesegment();
	TLinesegment(float base_point_coordinate_x, float base_point_coordinate_y, float length, int degree);
	void Show(sf::RenderWindow& window) override;
	void MoveTo(float change_coordinate_x, float change_coordinate_y) override;
	void Free(TLinesegment**& ptr_linesegments_mass, int& count_size_mass_linesegments);
	float getDegree();
	float getLength();
	float getWidth();
	void changeLength(int dlength);
