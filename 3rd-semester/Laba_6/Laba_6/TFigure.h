...
public:
	...
	void Show(sf::RenderWindow& window) override;
	void Free(TEllipse* ptr_ellipse);
...
public:
	...
	void Show(sf::RenderWindow& window) override;
	void Free(TQuadrilateral* ptr_quadrilateral);
...
public:
	...
	void Show(sf::RenderWindow& window) override;
	void Free(TTrapeze* ptr_trapeze);
...
public:
	...
	void Show(sf::RenderWindow& window) override;
	void Free(TRectangle* ptr_rectangle);
	float getLength();
	float getWidth();
...
public:
	...
	void Show(sf::RenderWindow& window) override;
	void Free(TRhombus* ptr_rhombus);
	float getLength();
	int getDegree();
	void changeLength(int dlength);
