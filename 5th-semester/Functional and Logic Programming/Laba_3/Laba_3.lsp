; Program name: Laba_3.lsp
; Author: Andrew
; Creation date: 20.11.2023
; Description:

;Нерекурсивная функция для подсчета суммы ряда целых чисел от n до 2n (первая пользовательская функция)
(defun UF1 (n)
...
;Функция вычисления среднего арифметического "массива" (вторая пользовательская функция)
(defun average (mass)
...
;Вспомогательная функция для нахождения среднего арифметического
