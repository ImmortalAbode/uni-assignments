...
var str_text = 'В вашей жизни происходят невероятные изменения, когда вы решаете взять под контроль то, над чем у вас есть власть, вместо того, чтобы жаждать контроля над тем, чего у вас нет.';
WScript.Echo("Исходный текст: " + str_text);
//Переменные.
var word_length = 5; //Заданная длина искомых слов.
